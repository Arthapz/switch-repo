...
target("libc")
    ...
    add_includedirs("newlib/libc/machine/aarch64/", {public = true})
    add_includedirs("newlib/libc/machine/aarch64/sys", {public = true})
    add_includedirs("newlib/libc/sys/arm", {public = true})
    add_includedirs("newlib/libc/include", {public = true})
